...
import img from '../assets/rich.jpg';
  ...
  return (
    ...
    <div className='flex p-24 space-x-20'>
      <div className='w-2/5 relative'>
        <div className='absolute -top-5 left-20 w-4/5  h-full'>
          <div className='w-full h-full bg-piccol border-8 border-bocol ' style={{ height: '110%' }}></div>
        </div>
        <img src={img} alt="Profile" className='w-4/5 relative z-10 ' />
      </div>
      <div className='w-3/5'>
